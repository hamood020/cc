...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleAddRecord(e) {
        ...
        if (success) {
            ...
            alert('تم إضافة السجل محلياً، لكن حدث خطأ أثناء الحفظ على الخادم. سيتم المحاولة مرة أخرى عند الضغط على زر "حفظ التغييرات".');
        }
    }
    ...
    async function handleEditRecord(e) {
        ...
        if (success) {
            ...
            alert('تم تعديل السجل محلياً، لكن حدث خطأ أثناء الحفظ على الخادم. سيتم المحاولة مرة أخرى عند الضغط على زر "حفظ التغييرات".');
        }
    }
    ...
    async function confirmDelete() {
        ...
        if (success) {
            ...
            alert('تم حذف السجل محلياً، لكن حدث خطأ أثناء الحفظ على الخادم. سيتم المحاولة مرة أخرى عند الضغط على زر "حفظ التغييرات".');
        }
    }
    ...
    async function processImportedData(jsonData) {
        ...
        if (success) {
            ...
            alert('تم استيراد البيانات محلياً، لكن حدث خطأ أثناء الحفظ على الخادم. سيتم المحاولة مرة أخرى عند الضغط على زر "حفظ التغييرات".');
        }
    }
